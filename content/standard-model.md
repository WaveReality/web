...
* [[Complex waves]] represent an alternative way of capturing the rotational oscillation present in physical waves, and this page provides an important overview of the relative properties of the whole family of different wave functions used in quantum mechanics, including the [[Schrodinger]] and [[Weyl]] functions, which are first-order wave equations that depend entirely on complex number rotation.
