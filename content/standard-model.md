...
These diagrams are ultimately where the _nonlinear_ nature of particle interactions is manifest, by discretizing the interactions in terms of these particles and their discrete properties, and computing scattering matricies (S-matrix) that reflect possible interactions that would take place at close range. These interactions are subject to energy thresholds and other conservation principles that make them nonlinear. 
