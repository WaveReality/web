...
{id="table_examples" title="Examples of relative velocities"}
|          |         |           |                         |
|----------|---------|-----------|-------------------------|
...
{id="eq_p-start" title="momentum"}
$$
p = \gamma m_0 v
$$

{id="eq_flip-v" title="flip to solve for v"}
$$
