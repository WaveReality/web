...
The **Spinfield Model** represents an attempt to understand the same phenomenology as the [[Standard Model]] from a mechanistic perspective, in terms of the [[cellular automaton]] (CA) and [[pilot-wave]] frameworks. As in many other cases, this alternative model could provide a more satisfying [[tools-vs-models|physical model]] of the same phenomena described by the calculational tool of the Standard Model. The CA framework introduces a natural ultraviolet cutoff scale, which can potentially explain the success of the [[renormalization]] procedure, and the mass hierarchy issues with the [[Higgs]] mechanism.
