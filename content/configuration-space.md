...
In the end, there is a compelling argument that conventional 3D space provides the only standard reference frame for physics that is universally applicable ([[@Wallace21]]). 
