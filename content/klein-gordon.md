...
In any case, this new equation ([[#eq_kg]]) is called the **Klein-Gordon (KG)** equation, named after Oskar Klein and Walter Gordon, who published the first papers on it ([[@Klein26]]; [[@Gordon26]]; see [[@Kragh84]] for a detailed history of this equation, which was actually discovered by many individuals, including [[@Schrodinger26]]; [[@Fock26]]; [[@Broglie26]]). This equation captures a surprising number of important phenomena, as we detail next.
