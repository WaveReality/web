...
It has a very short interaction range, on the scale of a proton charge radius ($10^-15$m), as predicted by the massive nature of the force carriers, the **W** and **Z** bosons. Given that these are massive particles, the same arguments about [[photons]] just being synonymous with the [[Maxwell]] wave functions do not apply.
