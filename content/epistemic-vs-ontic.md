...
There are increasingly strong theoretical and empirical attempts to show that a purely epistemic account contradicts quantum theory ([[@PuseyBarrettRudolph12]], [[@RingbauerDuffusBranciardEtAl15]]; [[@DasBhowmikParasharBanik21]]), so there is good reason to believe in the central premise of **wave reality** (see also the [[double-slit]] experiment). 
