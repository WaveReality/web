...
**Virtual particles** are used in quantum [[field theory]] to represent interactions among particles, as a key element of the [[Standard Model]]. They are different from real particles in that they do not appear in the input or output sides of the _S-matrix_ that defines the inputs and outputs of a scattering (particle interaction) event. Their parameters are typically related to those of the real inputs or outputs, in terms of energy, momentum, spin, charge, etc.
